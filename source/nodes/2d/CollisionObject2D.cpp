...
namespace M3DS {
    ...
    Failure deserialiseCollisionShape(SPhys::Shape2D& shape, Deserialiser& deserialiser) noexcept {
        std::uint8_t index;
    ...
    Failure CollisionObject2D::serialise(Serialiser& serialiser) const noexcept {
    ...
    Failure CollisionObject2D::deserialise(Deserialiser& deserialiser) noexcept {
